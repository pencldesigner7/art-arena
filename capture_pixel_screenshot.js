...
async function capturePixelScreenshot() {
  console.log('Capturing Pixel Theme profile modal screenshot...');
  ...
  // Set subscription and pixel theme
  ...
  await pool.query(
    `UPDATE users SET ui_theme = 'pixel', created_at = '2026-09-02T12:00:00Z' WHERE id = $1`,
    [userId]
  );
  ...
  if (cardElement) {
    await cardElement.screenshot({
      path: '/home/user/pixel_theme_rendered.png',
    });
    console.log('✓ Saved screenshot to /home/user/pixel_theme_rendered.png');
  }
...
capturePixelScreenshot().catch((err) => {
