...
async function captureGlitchScreenshot() {
  console.log('Capturing Glitch Theme profile modal screenshot...');
  ...
  // Set subscription and glitch theme
  ...
  await pool.query(
    `UPDATE users SET ui_theme = 'glitch', created_at = '2026-09-02T12:00:00Z' WHERE id = $1`,
    [userId]
  );
  ...
  if (cardElement) {
    await cardElement.screenshot({
      path: '/home/user/glitch_theme_rendered.png',
    });
    console.log('✓ Saved screenshot to /home/user/glitch_theme_rendered.png');
  }
...
captureGlitchScreenshot().catch((err) => {
