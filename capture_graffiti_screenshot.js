...
async function captureGraffitiScreenshot() {
  console.log('Capturing Graffiti Theme profile modal screenshot...');
  ...
  // Set subscription and graffiti theme
  ...
  await pool.query(
    `UPDATE users SET ui_theme = 'graffiti', created_at = '2026-09-02T12:00:00Z' WHERE id = $1`,
    [userId]
  );
  ...
  if (cardElement) {
    await cardElement.screenshot({
      path: '/home/user/graffiti_theme_rendered.png',
    });
    console.log('✓ Saved screenshot to /home/user/graffiti_theme_rendered.png');
  }
...
captureGraffitiScreenshot().catch((err) => {
