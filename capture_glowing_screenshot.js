...
async function captureGlowingScreenshot() {
  console.log('Capturing Glowing Theme profile modal screenshot...');
  ...
  // Set subscription and glowing theme
  ...
  await pool.query(
    `UPDATE users SET ui_theme = 'glowing', created_at = '2026-09-02T12:00:00Z' WHERE id = $1`,
    [userId]
  );
  ...
  if (cardElement) {
    await cardElement.screenshot({
      path: '/home/user/glowing_theme_rendered.png',
    });
    console.log('✓ Saved screenshot to /home/user/glowing_theme_rendered.png');
  }
...
captureGlowingScreenshot().catch((err) => {
