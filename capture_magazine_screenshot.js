...
async function captureMagazineScreenshot() {
  console.log('Capturing Magazine Cutout Theme profile modal screenshot...');
  ...
  // Set subscription and magazine theme
  ...
  await pool.query(
    `UPDATE users SET ui_theme = 'magazine', created_at = '2026-09-02T12:00:00Z' WHERE id = $1`,
    [userId]
  );
  ...
  if (cardElement) {
    await cardElement.screenshot({
      path: '/home/user/magazine_theme_rendered.png',
    });
    console.log('✓ Saved screenshot to /home/user/magazine_theme_rendered.png');
  }
...
captureMagazineScreenshot().catch((err) => {
